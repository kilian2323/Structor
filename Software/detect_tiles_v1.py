...
pxSize = 100  # Size of a machine-produced tile picture
...
class Tile:
	...
	@classmethod
	def specific(_num,_baseSignature,_numRotations,_bitmap):
		num = _num
		baseSignature = _baseSignature
...
if len(contours) != 0:
	...
	### Identify tile type and orientation for each signature
