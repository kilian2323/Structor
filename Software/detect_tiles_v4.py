...
filename1 = './../Kilian_examples/ko_top_corr2.jpg'                  # ok with autoCurves
filename2 = './../Kilian_examples/hrt_top.jpg'                       # ok
filename3 = './../Kilian_examples/tests/p1.jpg'                      # ok without autoCurves
...
filename8 = './../Kilian_examples/tests/p2_landscape_gaps.jpg'       # ok without autoCurves
filename9 = './../Kilian_examples/tests/p2_rot.jpg'                  # not ok
filename10 = './../Kilian_examples/tests/p2_rot180_dist_gaps.jpg'
...
useFile = filename10   # Select which file to use
...
mc2 = cv2.resize(mask_crop.copy(), (round(w2/2),round(h2/2)))
